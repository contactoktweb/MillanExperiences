...
export const metadata: Metadata = {
  title: "Birthdays and Celebrations in Colombia | Millan Experiences",
  description:
    "Because some milestones deserve more than a dinner reservation. We design private celebrations that feel extraordinary — effortlessly and exactly as you imagined them.",
}

const experienceSteps = [
  {
    title: "Intimate",
    subtitle: "Private Villa Dinner",
    description: "A bespoke menu, floral setup, ambient lighting and a curated playlist — designed exclusively for your closest people.",
    image: "/millan/cel-exp-dinner.webp"
  },
  {
    title: "Adventure",
    subtitle: "Private Island Day",
    description: "Your own island, your group, an open bar and a Caribbean sunset. The kind of birthday that becomes a legend.",
    image: "/millan/cel-exp-island.webp"
  },
  {
    title: "Exclusive",
    subtitle: "Yacht & Beach Club",
    description: "Private yacht all day, followed by an exclusive table or venue buyout at Cartagena's best beach club.",
...
const addons = [
  ...
  { title: "Custom cake & decoration", image: "/millan/cel-addon-cake.webp" },
  { title: "Custom branded experiences", image: "/millan/corp-addon-branded.webp" },
  { title: "Gift sourcing & preparation", image: "/millan/cel-addon-gifts.webp" },
      ...
      <main id="main">
        ...
        <section className="relative flex min-h-[85svh] items-center overflow-hidden bg-[var(--color-deep-sea)] pt-32 pb-24 md:pb-32">
          <div className="absolute inset-0">
             <Image
                src="/millan/cel-hero.webp"
                alt="Birthdays and Celebrations in Colombia"
                fill
                priority
          ...
          <div className="relative z-10 mx-auto w-full max-w-[1440px] px-6 md:px-10 text-[var(--color-warm-white)]">
             <div className="max-w-2xl">
               ...
               <h1 className="display mt-4 text-[clamp(3rem,5vw,5rem)] leading-tight">Birthdays and Celebrations in Colombia</h1>
               <p className="mt-8 font-sans text-lg font-light leading-relaxed text-[var(--color-warm-white)]/90">
                 Because some milestones deserve more than a dinner reservation. We design private celebrations that feel extraordinary — effortlessly and exactly as you imagined them.
               </p>
               <div className="mt-10">
                 <Cta href="/contact" tone="sand">Plan your celebration</Cta>
               </div>
             </div>
          </div>
        </section>
        ...
        <section className="bg-[var(--color-card)] py-20 md:py-28 text-center px-6">
          <div className="max-w-4xl mx-auto">
            <h3 className="font-serif text-2xl md:text-3xl leading-relaxed text-[var(--color-text-dark)]">
              "Some trips are just trips. Others become the story you tell for the next ten years."
            </h3>
          </div>
        </section>
