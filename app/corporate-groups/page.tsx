...
export const metadata: Metadata = {
  title: "Corporate Retreats and Group Trips in Colombia | Millan Experiences",
  description:
    "Incentive trips, leadership retreats and team-building experiences in one of Latin America's most inspiring cities. We handle the logistics — you harvest the results.",
}

const experienceSteps = [
  {
    title: "Executive Retreats",
    subtitle: "Clarity at the Top",
    description: "Private villa, curated agenda and immersive experiences designed to spark alignment, strategic thinking and genuine connection among leadership teams.",
    image: "/millan/corp-exp-retreats.webp"
  },
  {
    title: "Team Building",
    subtitle: "Experiences That Bond",
    description: "Island days, city tours, cooking classes, sailing — memorable activities built for real connection, not forced team building.",
    image: "/millan/corp-exp-team.webp"
  },
  {
    title: "Incentive Trips",
    subtitle: "Reward That Motivates",
    description: "Reward your top performers with a world-class experience they will never forget — and always talk about.",
    image: "/millan/corp-exp-incentive.webp"
  }
]

const addons = [
  { title: "Professional photographer", image: "/millan/addon-photo.webp" },
  { title: "Private chef & group dinner", image: "/millan/corp-addon-chef.webp" },
  { title: "Spa & wellness experience", image: "/millan/addon-spa.webp" },
  { title: "Custom branded experiences", image: "/millan/corp-addon-branded.webp" },
  { title: "Private aviation transfers", image: "/millan/corp-addon-aviation.webp" },
      ...
      <main id="main">
        ...
        <section className="relative flex min-h-[85svh] items-center overflow-hidden bg-[var(--color-deep-sea)] pt-32 pb-24 md:pb-32">
          <div className="absolute inset-0">
             <Image
                src="/millan/corporate-hero.webp"
                alt="Corporate Retreats and Group Trips in Colombia"
                fill
                priority
          ...
          <div className="relative z-10 mx-auto w-full max-w-[1440px] px-6 md:px-10 text-[var(--color-warm-white)]">
             <div className="max-w-2xl">
               ...
               <h1 className="display mt-4 text-[clamp(3rem,5vw,5rem)] leading-tight">Corporate Retreats and Group Trips in Colombia</h1>
        ...
        <section className="bg-[var(--color-card)] py-20 md:py-28 text-center px-6">
          <div className="max-w-4xl mx-auto">
            <h3 className="font-serif text-2xl md:text-3xl leading-relaxed text-[var(--color-text-dark)]">
              "The best company trips aren't conferences with a different backdrop. They're experiences that remind people why they chose to work together — and make them want to keep doing it."
            </h3>
          </div>
        </section>
