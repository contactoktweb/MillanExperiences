...
export const metadata: Metadata = {
  title: "Yachts and Catamarans in Cartagena | Millan Experiences",
  description:
    "Discover the islands in the most exciting and effortless way with our premium experiences.",
}
...
const dummyBoats = [
  {
    ...
    rooms: 4,
    bathrooms: 3,
    image: "/millan/yacht-marlet.webp",
    href: "/yachts-catamarans/marlet",
  },
]
...
export default function YachtsCatamaransPage() {
  return (
    <>
      <Preloader />
      <SiteHeader />
      ...
      <main id="main">
        ...
        <section className="relative flex min-h-[75svh] items-center overflow-hidden bg-[var(--color-deep-sea)] pt-32 pb-24 md:pb-32">
          <div className="absolute inset-0">
             <Image
                src="/millan/yachts-hero.webp"
                alt="Yachts and Catamarans in Cartagena"
                fill
                priority
          ...
          <div className="relative z-10 mx-auto w-full max-w-[1440px] px-6 md:px-10 text-[var(--color-warm-white)]">
             <div className="max-w-2xl">
               ...
               <h1 className="display mt-6 text-[clamp(3rem,5vw,5rem)] leading-tight">Yachts and Catamarans in Cartagena</h1>
        ...
        <section className="relative flex min-h-[50svh] items-center overflow-hidden bg-[var(--color-deep-sea)] py-24 md:py-32">
          <div className="absolute inset-0">
             <Image
                ...
                alt="A More Intimate Way to Explore"
                fill
          ...
          <div className="relative z-10 mx-auto w-full max-w-[1440px] px-6 md:px-10 text-[var(--color-warm-white)] flex justify-center">
             <div className="max-w-3xl text-center">
               <h2 className="display text-[clamp(2.5rem,4vw,3.5rem)] leading-tight">A More Intimate Way to Explore</h2>
               <p className="mt-6 font-sans text-lg font-light leading-relaxed text-[var(--color-warm-white)]/85">
                 Prefer something more agile? Discover our curated collection of luxury speedboats—perfect for refined, fast-paced island hopping with privacy and style.
               </p>
               <div className="mt-10 flex justify-center">
                 <Cta href="/speedboats" tone="sand">Explore Our Speedboats</Cta>
               </div>
             </div>
          </div>
        </section>
