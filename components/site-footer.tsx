  ...
  return (
    <footer className="bg-[var(--color-deep-sea)] text-[var(--color-warm-white)]">
      ...
      <div className="border-t border-[color:var(--color-border-dark)]">
        <div className="mx-auto flex max-w-[1440px] flex-col items-center gap-8 px-6 py-8 md:flex-row md:justify-between md:px-10">
          ...
          <Link href="/" aria-label="Millan Experiences home" className="inline-block">
            <Image
